...
if(input$variable=="sex"){
  ...
  return(barplot(cbind(male=c(poptab[2]/100,samptab[2]/100),female=c(poptab[1]/100,samptab[1]/100)),
          beside=TRUE,col=c("red","lightblue"),main="Sex",
          ylim=c(0,ymax+0.2),legend=(c("Population","Sample"))))
...
if(input$variable=="math"){
  poptab=rowPerc(xtabs(~math,imagpop))
  samptab=rowPerc(xtabs(~math,data))
  ymax=max(poptab[1]/100,poptab[2]/100)
  return(barplot(cbind(No=c(poptab[1]/100,samptab[1]/100),Yes=c(poptab[2]/100,samptab[2]/100)),
          beside=TRUE,col=c("red","lightblue"),main="Math Major",
          ylim=c(0,ymax+0.2),legend=(c("Population","Sample"))))
  cat("\n Sample Summary for sample size", n,"\n")
  print(round(samptab,2))
  cat("\n Population Summary \n")
...
if(input$variable=="kkardashtemp"){
